...
<%
List<pImageDto1> list = (ArrayList<pImageDto1>)request.getAttribute("list");
%>
<center><h1 style="color:red;">LIST OF VOLUNTEERS</h1></center>
<p class="outset"></p>
...
%>
<tr><td><%=vid%></td><td><img src="./pDown1?vid=<%=vid%>" height="150" width="100"/></td><td><%=vname %></td>
<td><%=vfname %></td>
<td><%=vcourse%></td>
<td><%=vyear %></td>
<td><%=vage %></td>
